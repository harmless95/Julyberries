...
Revision ID: 9347ca9ead71
Revises: 74297b1c083a
Create Date: 2025-08-26 11:41:18.944226
...
revision: str = "9347ca9ead71"
down_revision: Union[str, Sequence[str], None] = "74297b1c083a"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("roles_id", "permission_id", name="idx_role_permissions"),
    )
    op.create_table(
        "users",
